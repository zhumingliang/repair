...
Route::get('api/:version/extend/handel', 'api/:version.Services/Extend/handel');
...
Route::post('api/:version/withdraw/apply/handel/shop', 'api/:version.Withdraw/applyHandelForShop');
